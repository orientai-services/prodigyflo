...
- Only Super Admin can assign/reassign clients. Changes are serialized with staff deactivation. Future live appointments follow the client; completed and past appointments retain authorship. Unassigned appointments remain visible to Admins.
