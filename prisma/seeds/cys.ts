...
export const SCHEMA_42_FIELDS: FieldSeed[] = [
  ...
  { key: 'product_confirmed', label: 'Product type confirmed', groupName: 'GX', position: 26, isRequired: true, dataType: 'string', sourceType: 'DOCUMENT_FIELD', sourcePath: 'document.solar_contract.installer_name', helpText: 'Ops extraction, not a client form' },
