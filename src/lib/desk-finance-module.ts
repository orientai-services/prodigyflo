...
export function agreementKind(raw: string | null | undefined): AgreementKind {
  ...
  if (s === 'ppa' || s.includes('power purchase')) return 'ppa'
...
/** Calendar time left on a PPA/lease. Not a loan remaining balance. */
