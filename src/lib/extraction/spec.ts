...
export const DOC_TYPE_SPECS: DocTypeSpec[] = [
  {
    ...
    fields: [
      ...
      { key: 'annual_usage_kwh', label: 'Annual usage (kWh)', required: false, kind: 'number' },
      { key: 'monthly_usage_kwh', label: 'Monthly usage (kWh)', required: false, kind: 'number' },
    ],
  },
  {
    key: 'government_id',
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'cash_price', label: 'Contract value', required: false, kind: 'money' },
      { key: 'first_payment_date', label: 'First payment date', required: false, kind: 'date' },
      { key: 'remaining_balance', label: 'Remaining scheduled payments', required: false, kind: 'money' },
      { key: 'interest_paid_to_date', label: 'Interest paid to date', required: false, kind: 'money' },
      { key: 'months_remaining', label: 'Months remaining', required: false, kind: 'number' },
      { key: 'years_remaining', label: 'Years remaining', required: false, kind: 'number' },
    ],
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'first_year_monthly_payment', label: 'First-year monthly payment', required: false, kind: 'money' },
      { key: 'intro_payment_count', label: 'Intro payment count', required: false, kind: 'number' },
      { key: 'first_payment_date', label: 'First payment date', required: false, kind: 'date' },
      { key: 'remaining_balance', label: 'Remaining balance', required: false, kind: 'money' },
      { key: 'interest_paid_to_date', label: 'Interest paid to date', required: false, kind: 'money' },
      { key: 'months_remaining', label: 'Months remaining', required: false, kind: 'number' },
      { key: 'years_remaining', label: 'Years remaining', required: false, kind: 'number' },
      { key: 'system_size_kw', label: 'System size (kW)', required: false, kind: 'number' },
